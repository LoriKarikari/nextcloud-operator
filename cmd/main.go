...
import (
	...
	"github.com/LoriKarikari/nextcloud-operator/internal/controller"
...
func init() {
	...
	utilruntime.Must(nextcloudv1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "9ebac71a.lorikarikari.io",
